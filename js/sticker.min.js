...
(function () {
  ...
  function f(r, w) {
    ...
    i(w.backImg, { transform: "scaleX(" + v + ") scaleY(" + u + ")" });
    i(w.depth, { transform: "translate(" + -10000 + "px, " + -10000 + "px)" });
  }
  function l(s, q) {
    if (b == null) {
      return;
    ...
    i(q.depth, { transform: "translate(" + -10000 + "px, " + -10000 + "px)" });
    b = null;
  }
  function a(A, E) {
    if (b == null) {
    ...
    i(E.move, { transform: "translate(" + -y + "px, " + -x + "px)" });
    i(E.back, { transform: "translate(" + w + "px, " + v + "px)" });
    i(E.backShadow, {
      width: u + "px",
      height: D + "px",
      transform: "translate(" + t + "px, " + s + "px)",
